...
/*
 * Runtime: 280 ms       Your runtime beats 55.04 % of csharp submissions.
 * Memory Usage: 46.1 MB
 */

namespace _0575_DistributeCandies
{
    class Program
    {
        ...
        {
            // The max is half the candies
            var maxCandies = candyType.Length / 2;

            // The max candy count is limited by the types
            var candyTypes = candyType.Distinct().Count();
